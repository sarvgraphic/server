...
module.exports.cors = {
    ...
    headers : 'X-Access-Token, Origin, X-Requested-With, Content-Type, Accept, Accept-Language, Content-Language, cookie, connection, user-agent, referer, accept-encoding, scope, entityKey'
