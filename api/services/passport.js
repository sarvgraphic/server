...
passport.create = function(createObj){
    return new Promise(function(resolve, reject){
        Passport.create(createObj).exec(function(err, created){
            if(err){
                reject(err);
            } else {
                resolve(created);
...
passport.update = function(condition, updateObj){
    return new Promise(function(resolve, reject){
        Passport.update(condition, updateObj).exec(function(err, passport){
            if(err){
                reject(err);
            } else {
                resolve(passport);
